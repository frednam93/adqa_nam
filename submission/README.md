...
- `Nam_IND_task5_4`: ensemble of systems 1, 2, and 3 after Gemma-4-E4B-it parse-bad response normalization; remaining ties are broken by system 2. Total model size is 94B.
