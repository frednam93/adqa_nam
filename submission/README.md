...
- `Nam_IND_task5_4`: ensemble of systems 1, 2, and 3 after Qwen3.5-9B parse-bad response normalization; remaining ties are broken by system 2. Total model size is 99B.
